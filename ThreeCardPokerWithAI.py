...
class Game(object):
    ...
    def checkWinner(self, player_hand, computer_hand, value_computer, value_user, new_bet, user_wallet, computer_wallet):
        ...
        print("\nYour cards are: ", player_hand[0], " | ", player_hand[1]," | ", player_hand[2], "\n")
        print("Computers cards are:", computer_hand[0]," | ", computer_hand[1]," | ", computer_hand[2], "\n") 
    ...
    def poker(self):
        ...
        while(play):
            ...
            if user_wallet == 0: # Checks if the user has enough money
                ...
                print("Computer Wallet: ", user_wallet) #Checks if the computer is gaining money over time
            ...
            if(fold > 1):
                ...
                if count == 0 or computer_wallet < 0: # Checks if computer_wallet is negative or if the random counter is at 0 to call the AI algorithm
                    ...
                    print("\nComputers turn")
                    count -= 1 #counts one down
                    if bet*4 > new_bet: #Checks if bet is too high for 
                        ...
                        user_wallet = new_bet + user_wallet
                    play_again = int(input("\nDo you want to play again? press '1' for yes press '2' for no: "))
                    if play_again == 2:
                        play = False
                else:
